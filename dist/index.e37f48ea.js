...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        // Close form to see UI
        setTimeout(function() {
            (0, _addRecipeViewJsDefault.default).toggleWindow();
        }, (0, _configJs.MODAL_CLOSE_SEC) * 1000);
        // Success message
        (0, _addRecipeViewJsDefault.default).renderMessage();
        // Renew bookmark view (rerender)
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        // Change ID in URL
...
},{"core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/bookmarksView.js":"4Lqzq","./views/paginationView.js":"6z7bi","./views/addRecipeView.js":"i6DNj","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSXXb":[function(require,module,exports) {
...
const updateServings = function(newServings) {
    ...
    // newQt = oldQt * newSerbings / oldServings
    });
...
const KEY = `6782561e-af1e-4e60-ae7e-c05893d64624`;
...
},{"url:../../img/icons.svg":"loVOp","fracty":"hJO4d","./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
